...
STRINGS: dict[str, str] = {
    ...
    "board.map_pool_line": "{mark} {game} — **{enabled}/{total}** enabled",
    "board.map_pool_line_empty": "{mark} {game} — _not seeded_",
    "board.competitive": "Competitive pool",
    "board.competitive_line": "{mark} {game}: {maps}",
    "board.approvals": "Rank approvals",
    "board.approvals_pending": "**{n}** pending — {by_game}",
    "board.approvals_none": "_none pending_",
    "board.admins": "Admins",
