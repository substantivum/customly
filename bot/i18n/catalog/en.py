...
STRINGS: dict[str, str] = {
    ...
    "common.nobody": "_nobody_",
    "common.nobody_yet": "_nobody yet_",
    "common.not_set": "_not set_",
    "common.none": "_none_",
    "common.tbd": "TBD",
    ...
    "custom.reg.no_one": "_no one yet_",
    ...
    "board.player.desc": (
        "Every open game is listed below. Press **Browse & join** to open your "
        "own private menu — pick a game, register or leave, check the roster."
    ),
    "board.admin.title": "Admin Panel",
    "board.admin.desc": "Create and run customs. Every button opens a private menu.",
    "board.super.title": "Super Admin",
    "board.super.desc": "Server-wide controls. Every button opens a private menu.",
    ...
    "board.line.owner": "owner <@{owner_id}>",
    ...
    "screen.roles.none": "_none granted_",
    ...
    "confirm.delete.title": "Delete Custom #{custom_id}?",
    "confirm.delete.desc": (
        "**{name}** — its channel, voice channels and queue all go away. "
        "This can't be undone."
    ),
    "confirm.prune.title": "Delete every custom in this server?",
    "confirm.prune.desc": (
    ...
    "draft.on_clock_value": "<@{captain_id}> ({side}) — {n} left",
    ...
    "veto.turn_action": "<@{captain_id}> to {action}",
    "veto.turn_side": "<@{captain_id}> picks a side on **{map}**",
    ...
    "ready.footer": "**Can't play** frees your seat for a sub straight away.",
    ...
    "ready.why.rounds": "gave up after {n} rounds",
    ...
    # ------------------------------------------------------------- profile ---
    "profile.registered": "Registered as **{tag}**.",
    ...
    "stats.wl": "W/L",
    "stats.mvps": "MVPs",
    "stats.leader_line": "{rank}. <@{user_id}> — {wins} wins",
    ...
    "cmd.profile.register.desc": "Register your profile with your Riot ID tag.",
    "cmd.profile.register.riot_id": "Your Riot ID like TenZ#NA1",
    "cmd.profile.register.main_role": "Optional preferred role",
    "cmd.profile.register.cur_rank": "Optional, e.g. Ascendant 2",
    "cmd.profile.register.cur_rr": "Optional rank rating 0-100",
    "cmd.profile.register.peak_rank": "Optional, e.g. Immortal 1",
